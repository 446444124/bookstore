...
import com.PTU.interceptor.JwtTokenUserInterceptor;
import com.PTU.json.JacksonObjectMapper;
...
public class WebMvcConfiguration extends WebMvcConfigurationSupport {
    ...
    protected void addInterceptors(InterceptorRegistry registry) {
        ...
        registry.addInterceptor(jwtTokenUserInterceptor)
                ...
                .excludePathPatterns("/user/home/banners")
    ...
    public Docket docket2() {
        ApiInfo apiInfo = new ApiInfoBuilder()
                .title("莆田学院校园书店项目接口文档")
                .version("2.0")
                .description("莆田学院校园书店项目接口文档")
                .build();
        Docket docket = new Docket(DocumentationType.SWAGGER_2)
                .groupName("用户端接口")
                .apiInfo(apiInfo)
                .select()
                .apis(RequestHandlerSelectors.basePackage("com.PTU.controller.user"))
